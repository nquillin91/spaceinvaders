...
{
    class Round2Scene : Scene
    {
        public override void LoadScene()
        {
            AlienManager.Create(1.5f);
        ...
        private void BuildAlienGrid()
        {
            ...
            for (int i = 0; i < 11; i++)
            {
                ...
                pGameObj = alienFactory.Create(GameObject.Name.Squid, AlienCategory.Type.Squid, (64.0f + i * 64.0f), 565.0f);
                pCol.Add(pGameObj);

                pGameObj = alienFactory.Create(GameObject.Name.Crab, AlienCategory.Type.Crab, (64.0f + i * 64.0f), 530.0f);
                pCol.Add(pGameObj);

                pGameObj = alienFactory.Create(GameObject.Name.Crab, AlienCategory.Type.Crab, (64.0f + i * 64.0f), 495.0f);
                pCol.Add(pGameObj);

                pGameObj = alienFactory.Create(GameObject.Name.Octopus, AlienCategory.Type.Octopus, (64.0f + i * 64.0f), 460.0f);
                pCol.Add(pGameObj);

                pGameObj = alienFactory.Create(GameObject.Name.Octopus, AlienCategory.Type.Octopus, (64.0f + i * 64.0f), 425.0f);
                pCol.Add(pGameObj);
